...
class Map:  # Contains a 2D array of all the tiles, and a function that draws only visible tiles
    ...
    def __init__(self, image_name_array,
                 collidable_group):  # takes a 2D array of image names and a list of collidable sprites. Instantiates tiles with images as backgrounds and containing all collidable sprites within their area into the 2D array "tile array"
        self.tile_array = []
        x = 0
